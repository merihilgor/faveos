...
return [
    ...
    */
    ...
    'repository_types' => [
        'github' => [
            'type' => 'github',
            'repository_vendor' => env('SELF_UPDATER_REPO_VENDOR', 'ladybirdweb'),
            'repository_name' => env('SELF_UPDATER_REPO_NAME', 'Faveo-Helpdesk-Pro'),
            'repository_url' => '',
            'download_path' => env('SELF_UPDATER_DOWNLOAD_PATH', base_path('new-release')),
        ],
    ],
 ...
 /*
    ...
    */
    ...
    'mail_to' => [
        'address' => env('SELF_UPDATER_MAILTO_ADDRESS', 'splitnavz@yahoo.in'),
        'name' => env('SELF_UPDATER_MAILTO_NAME', 'Abhishek'),

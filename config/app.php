...
return [
    ...
    /*
      ...
      |
     */
    'version' => 'Faveo Enterprise v4.0.1',
    ...
    /*
      ...
      |
     */
      'name' => 'Faveo Helpdesk Enterprise',
    /*
      |--------------------------------------------------------------------------
      | Application URL
      |--------------------------------------------------------------------------
    ...
    'providers' => [
        ...
        App\Bill\BillServiceProvider::class,
        App\Location\LocationServiceProvider::class,
        App\MicroOrganization\MicroOrganizationServiceProvider::class,
        App\FaveoStorage\StorageServiceProvider::class,
        \App\AutoAssign\AutoAssignServiceProvider::class,
        \App\FaveoReport\ReportServiceProvider::class,
        \App\Api\ApiServiceProvider::class,
        Codedge\Updater\UpdaterServiceProvider::class,
        Berkayk\OneSignal\OneSignalServiceProvider::class,
        Yajra\DataTables\DataTablesServiceProvider::class,
        App\HelptopicType\HelptopicTypeServiceProvider::class,
    ...
    'aliases' => [
        ...
        /**
         * @TODO
         * Input Facade has been replaced by Request Facade so we need
         * to update all calls to Input:: by Ruquest:: and remove the below
         * line.
         */
        ...
        'Zipper' => 'Madnest\Madzipper\Facades\Madzipper',

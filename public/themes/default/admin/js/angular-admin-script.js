...
//Arabic language
 $(function () {
    ...
    adminRtl.href = commonPath+"themes/default/common/css/rtl/css/AdminLTE.css";
    document.head.appendChild(adminRtl);

     var cssRtl = document.createElement('link');
    cssRtl.id = 'id-csstrtl';
    cssRtl.rel = 'stylesheet';
    cssRtl.href = commonPath+"themes/default/common/css/rtl/css/rtl.css";
    ...
    $('.navbar-left').toggleClass('navbar-right');
       ...
       setTimeout(function(){
        ...
        $('.right-hand').css('float','left');
        $('.left-hand').css('float','right');
        $('.tree-handle').css({'margin-right':'0px','margin-left':'10px'});
    },2000)

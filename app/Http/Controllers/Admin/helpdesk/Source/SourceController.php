        ...
        return \DataTables::of($source)
                        ...
                        ->addColumn('action', function($source) {
                            if ($source->is_default == 1) {
                                return "<a href=" . url('source/' . $source->id . '/edit') . " class='btn btn-primary btn-xs' ><i class='fa fa-edit' style='color:white;'> </i>&nbsp;&nbsp;Edit</a>&nbsp;&nbsp;<a href='#' class='btn btn-primary btn-xs' disabled='disabled' ><i class='fa fa-trash' style='color:white;'> </i>&nbsp; Delete </a>";
                            } else {

                                $url = url('source/' . $source->id . '/delete');
                                $confirmation = deletePopUp($source->id, $url, "Delete", 'btn btn-primary btn-xs');

                                return "<a href=" . url('source/' . $source->id . '/edit') . " class='btn btn-primary btn-xs'><i class='fa fa-edit' style='color:white;'> </i>&nbsp;&nbsp;Edit</a>&nbsp;&nbsp;"
                                        . $confirmation;
                            }
                        })

...
class DepartmentController extends Controller
{
    ...
    public function DepartmentShow($id)
    {
        ...
        $ticket_policy = $this->ticketPolicy;
        $tickets       = new Tickets();
        return view('themes.default1.admin.helpdesk.agent.departments.show', compact('departments', 'deptManagerDetails', 'department_members', 'user', 'tickets', 'ticket_policy'));
    }
    ...
    public function getDepartmentTable()
    {
        ...
        return \DataTables::of($department)
            ...
            ->addColumn('action', function ($department) {
                ...
                return
                '<a href="' . route('departments.edit', $department->id) . '" class="btn btn-primary btn-xs "><i class="fa fa-edit" style="color:white;"> &nbsp;</i> ' . Lang::get('lang.edit') . '</a>&nbsp;&nbsp;'
                . '<a href="' . route('department.profile.show', $department->id) . '" class="btn btn-primary btn-xs "><i class="fa fa-eye" style="color:white;"> &nbsp;</i> ' . Lang::get('lang.view') . '</a>&nbsp;&nbsp;'
                . $confirmation
                . \Form::close();
            })

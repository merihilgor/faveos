...
class DeleteAccountController extends HandleAccountController
{
    ...
    private function getDeletedUserAttributes():array
    {
        return [
            ...
            'country_code' => null,
            'ext' => null,
            'profile_pic' => 'deletedcontacthead.png'
        ];
    }
     ...
     * @return void
     */
    protected function handleOwnedTicketsForDeactivation(string $action="delete")
    {
        if($this->request['action_on_owned_tickets'] == 'delete'){
            return $this->deleteUserTicketsAndDependencies();
        }

        return parent::handleOwnedTicketsForDeactivation($action);
    }

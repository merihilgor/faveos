...
class TicketsActionOptionsController extends Controller
{
    ...
    public function getActionList(Request $request)
    {
        ...
        $allowedActions = [
            'assign' => $this->isAssignable($ticket, $ticketPolicy),
    ...
    private function isDuedateChangeable($ticket)
    {
        ...
        return (new TicketPolicy())->changeDuedate() && !$ticket->statuses->halt_sla;
    }
     ...
     * @return bool
     */
    private function isAssignable(Tickets $ticket, TicketPolicy $ticketPolicy) : bool
    {
      /*
      ...
      */
      if(!$ticket->assigned_to && !$ticket->team_id){
        return $ticketPolicy->assign();
      }
      return $ticketPolicy->reAssigningTickets();
    }
    ...
    private function isRemovalApprovalWorkflowActionAllowed($ticketId)
    {
        ...
        return ($isApprovalWorkflowRemoveActionAllowed && (new TicketPolicy)->applyApprovalWorkflow());
    }
}

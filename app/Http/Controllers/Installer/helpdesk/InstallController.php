...
class InstallController extends Controller
{
    ...
    public function accountcheck(Request $request)
    {
        ...
        $permisions = '{"create_ticket":"1","edit_ticket":"1","close_ticket":"1","transfer_ticket":"1","delete_ticket":"1","assign_ticket":"1","access_kb":"1","organisation_document_upload":"1","email_verification":"1","mobile_verification":"1","account_activate":"1"}';
    ...
    public function finalize(Request $request)
    {
        ...
        if ($result['notification_case']=="notification_license_ok") {
            ...
            try {
                ...
                $this->updateInstalEnv($environment);
                Session::flush();
    ...
    public function updateInstalEnv(string $environment)
    {

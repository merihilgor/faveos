...
class PhpMailController extends Controller {
    ...
    = "", $thread = "", $auto_respond = "", $logIdentifier) {
      ...
      try{
        ...
        if($from_address->sending_protocol == 'ews'){
            (new ExchangeWebServices($from_address))->sendMailByEWS($to, $toname, $subject, $data, $cc, $attachments, $reference);
    ...
    private function attachFile($message, $file)
    {
        ...
        // ticket attachments
        $filePath = $file['path'] . DIRECTORY_SEPARATOR . $file['name'];

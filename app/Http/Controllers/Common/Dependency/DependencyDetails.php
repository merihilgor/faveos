...
class DependencyDetails extends DependencyController
{
     ...
     */
    public function getDependencyDetails(string $key, $value, bool $meta = false, bool $config = false)
    {
        if(!$value){
            return [];
        }
        ...
        $parameters = ['meta' => $meta, 'limit' => 'all', 'config'=> $config, 'ids' => $value];

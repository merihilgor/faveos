...
class DependencyController extends NonPublicDependencies
{
    ...
    protected function helpTopics()
    {
        ...
        if ($this->supplements) {
            $baseQuery = $this->limitLinkedHelpTopics($baseQuery, $this->supplements);
        }
    ...
    {
        //check for foreign key for helptopic
    ...
    */
    private function listPermission()
    {
        $permissions = [
                ...
                ['id' => 'user_activation_deactivaton', 'name' => 'Activate or Deactivate user account'],
                ['id' => 'agent_activation_deactivaton', 'name' => 'Activate or Deactivate agent account'],
                ['id' => 'delete_user_account', 'name' => 'Delete user account'],
                ['id' => 'delete_agent_account', 'name' => 'Delete user account'],
            ];
        return $permissions;
    }
    ...
    */
    ...
    protected function departments()
    {
        ...
        // if supplements is not empty, then get helptopics linked with passed department
        if ($this->supplements) {
            $baseQuery = $this->limitLinkedDepartments($baseQuery, $this->supplements);
        }

...
class SettingsController extends Controller {
    ...
    */  
     ...
     * @return type
     */
    public function PostPlugins(PluginsPageRequest $request) 
    {
        try {
            if (!extension_loaded('zip')) {
                // throw new Exception('Please enable zip extension in your php.ini file');
                return errorResponse('Please enable zip extension in your php.ini');
            }
            $plug = new Plugin();
            ...
            if (in_array($filename, $dir_check)) {
                return errorResponse(trans('lang.plugin-exists'));
            }
            ...
            if (file_exists($file)) {
                ...
                if (file_exists($seviceporvider) && file_exists($config)) {
                    ...
                    if ($faveoconfig) {
                        ...
                        return successResponse(trans('lang.plugin-installed'));
                    } else {
                        /*
                        ...
                        return errorResponse(trans('lang.no-plugin-file'));
                    }
                } else {
                    /*
                     * delete if the plugin hasn't config.php and ServiceProvider.php
                    ...
                    return errorResponse(trans('lang.plugin-config-missing'));
                }
            } else {
                /*
                ...
                return errorResponse(trans('lang.plugin-path-missing'));
            }
        } catch (Exception $ex) {
            Logger::exception($ex);
    ...
    public function DeletePlugin($slug) 
    {
        ...
        return successResponse(trans('lang.plugin_deleted'));
    }

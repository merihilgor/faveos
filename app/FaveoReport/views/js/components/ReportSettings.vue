<template>
	<div>
		...
		<faveo-box :title="trans('settings')">
				...
				<div class="row">
					<static-select :label="trans('record_per_export')" :value="records" name="records" classname="col-xs-6" :elements="elements"
					...
					<div class="col-xs-12">
						...
						<button type="button" id="submit_btn" @click="onSubmit()" class="btn btn-primary" :disabled="isDisabled">
							<i class="fa fa-save" aria-hidden="true"></i> {{trans('submit')}}</button>

...
class DashboardController extends BaseReportController
{
    ...
    {
        $widgetTypes = [
            "my_tickets"=> ['icon_class'=>'fa fa-inbox', 'icon_color'=>'#007bff'],
            "my_overdue_tickets"=> ['icon_class'=>'fa fa-calendar-times-o', 'icon_color'=>'#dd4b39'],
            "my_due_today_tickets" => ['icon_class'=>'fa fa-calendar-times-o', 'icon_color'=>'#f39c12'],
            "my_pending_approvals"=> ['icon_class'=>'fa fa-clock-o', 'icon_color'=>'#00c0ef'],
        ];
        ...
        if(!(new TicketPolicy)->restrictedAccess() || (new TicketPolicy)->globalAccess()){
            $widgetTypes = array_merge($widgetTypes,
                [
                    "open_tickets"=> ['icon_class'=>'fa fa-inbox', 'icon_color'=>'#007bff'],
                    "overdue_tickets"=> ['icon_class'=>'fa fa-calendar-times-o', 'icon_color'=>'#dd4b39'],
                    "unassigned_tickets"=> ['icon_class'=>'fa fa-user-times', 'icon_color'=>'#f39c12'],
                    "unanswered_tickets"=> ['icon_class'=>'fa fa-reply', 'icon_color'=>'#00c0ef'],
                ]);
        }

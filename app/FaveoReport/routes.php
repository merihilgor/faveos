...
Route::group(['middleware' => ['web', 'auth', 'role.agent'], 'prefix' => 'report'], function () {
...
//    ]);
    ...
    Route::get('api/agent/export/download/{hash}', [
        ...
        'uses' => 'App\FaveoReport\Controllers\ReportExportController@downloadReportExport',
    ]);
 ...
 */
Route::group(['middleware' => ['web', 'auth', 'role.agent', \App\FaveoReport\Middleware\AccessReport::class]], function() {
...
Route::group(['middleware' => ['web', 'auth', 'role.agent']], function() {
    // gets dashboard view

...
class CustomFormValue extends Model
{
    ...
    public function setValueAttribute($value)
    {
        ...
        if (!$this->isValidFormValue($fieldType, $value)) {
     ...
     * @param  object $ticket      ticket for which custom field has to be created
     * @return null
     */
    ...
    {
        $fieldType = FormField::find($this->form_field_id)->type;
        return $fieldType;
    }
}

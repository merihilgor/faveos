...
class Label extends Model
{
    ...
    public function titleWithColor()
    {
        ...
        $color = $this->color;
        if ($title && $color) {
            return "<a href='".url('tickets?labels[]='.$title)."' title='".Lang::get('lang.timeline-links-title', ['filtername' => Lang::get('lang.label'), 'filtervalue' => $title])."' class='label' style='background-color:" . $color . "; color: #FFF;'>" . $title . "</a>";
        } else {
            return "--";
        }
    }

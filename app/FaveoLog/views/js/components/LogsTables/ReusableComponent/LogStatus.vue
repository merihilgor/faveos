<template>
    <div>
      <span :id="'log-status-' + data.id" :class="['badge', badgeClass, 'log-status', 'text-uppercase']" @click="showModal = Boolean(data.exception)" :title="getStatusTitle" :style="data.exception ? {cursor: 'pointer'} : {} ">
        {{lang(data.status)}}
      </span>

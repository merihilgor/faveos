...
class StorageControllerTest extends DBTestCase
{
    ...
    public function test_upload_whenInvalidFileIsUploadedFromCkEditor_shouldReturnFailureResponse()
    {
        ...
        $response->assertStatus(412)
            ->assertJsonFragment(["upload" => "The upload must be an image."]);
    ...
    public function test_getThumbnailUrl_whenAFilePathIsPassedWhichIsTxt_shouldGivePathToAnIconWhichIsPresentInPublicFolder()
    {
        ...
        $methodResponse = $this->storageController->getThumbnailUrl($fileWhichExistsButNotImage, "test_hash");
    ...
    {
        $fileWhichDoesntExist = base_path()."/app/FaveoStorage/tests/FakeFiles/test.kbc";
    ...
    public function test_getThumbnail_whenAnValidHashIsPassedAndImageExists_shouldGiveThatImageAsResponse()
    {
        ...
        $this->getLoggedInUserForWeb("admin");
        $methodResponse = $this->call("GET","api/thumbnail/$attachmentObject->hash_id");
        $this->assertEquals("pdf.png", $methodResponse->getFile()->getFilename());
    }

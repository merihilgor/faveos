    ...
    <faveo-box :title="lang('ldap_configuration_settings')">
      ...
      <div style="margin-top: 2rem;">
        ...
        <faveo-box :title="lang('connection_settings')" >
          <div class="row">
            ...
            <!-- Username -->
            <text-field label="Username" :value="username" type="text" name="username" :onChange="onChange" classname="col-xs-4" :required="true" id="username">
            </text-field>

            <!-- Password  -->
            <text-field label="Password" :value="password" type="password" name="password" :onChange="onChange" classname="col-xs-4" :required="true" id="password">
            </text-field>

            <static-select :label="lang('ldap_schema')" :elements="schemas" name="schema" :value="schema" classname="col-xs-4" :onChange="onChange" :hint="lang('ldap_schema_description')" id="schema">
            </static-select>

            <text-field :label="lang('port')" :value="port" type="number" name="port" :onChange="onChange" classname="col-xs-4" :hint="lang('ldap_port_hint')" id="port">
            </text-field>

            <static-select :label="lang('encryption')" :elements="encryptions" name="encryption" :value="encryption" classname="col-xs-4" :onChange="onChange" :hint="lang('ldap_encryption_hint')" id="encryption">
            </static-select>
          </div>
        </faveo-box>
      </div>
      ...
      <div style="margin-top: 2rem;">
        ...
        <faveo-box :title="lang('login_settings')" >
          <div class="row">
            <!-- ldap label  -->
            <text-field :label="lang('ldap_label')" :value="ldap_label" type="text" name="ldap_label" :onChange="onChange" classname="col-xs-4" :hint="lang('ldap_label_hint')" id="label">
            </text-field>

            <!-- forgot password link  -->
            <text-field :label="lang('forgot_password_link')" :value="forgot_password_link" type="text" name="forgot_password_link" :onChange="onChange" classname="col-xs-4" :hint="lang('forgot_password_link_description')" id="forgot-password-link">
            </text-field>

            <!--   -->
            <text-field :label="lang('username_prefix')" :value="prefix" type="text" name="prefix" :onChange="onChange" classname="col-xs-4" :hint="lang('username_prefix_description')" id="prefix">
            </text-field>

            <!-- ldap label  -->
            <text-field :label="lang('username_suffix')" :value="suffix" type="text" name="suffix" :onChange="onChange" classname="col-xs-4" :hint="lang('username_suffix_description')" id="suffix">
            </text-field>
      ...
      <!-- SAVE THE CONFIGURATION -->
        <button slot="actions" id="ldap-settings-submit" class="btn btn-primary ldap-update update-btn" @click="saveConfiguration" :disabled="loading">

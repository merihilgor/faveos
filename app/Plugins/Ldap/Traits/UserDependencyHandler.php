...
trait UserDependencyHandler
{
  ...
  */
  private function assignDefaultPermissions(User $user)
  {
      ...
      $defaultPermissions = [
        "create_ticket" => 1,"edit_ticket" => 1,"close_ticket" => 1,
        "transfer_ticket" => 1,"delete_ticket"=>1,"assign_ticket" => 1,
        "access_kb" => 1,"ban_email" => 1,"organization_document_upload" => 1,
        "account_activate"=>1,"report"=>1,"agent_account_activate"=>1
      ];

      //update permission table
      return $user->permision()->create(['permision'=>$defaultPermissions]);
  }

            ...
            <div class="box-body">
                ...
                <div class="row">
                    ...
                    <text-field 
                        ...
                        classname="col-xs-6" :hint="lang('sid_hint')" 
                        id="sid" 
                    />
                ...
                <div class="row">
                    ...
                    <text-field 
                        ...
                        classname="col-xs-6" :hint="lang('token_hint')" 
                        id="token" 
                    />
                    ...
                    <text-field 
                        ...
                        classname="col-xs-6" :hint="lang('business_phone_hint')" 
                        id="business_phone"
                    />
                ...
                <div class="row">
                    ...
                    <text-field 
                        ...
                        classname="col-xs-6" :hint="lang('webhook_url_hint')" 
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <text-field
                            ...
                            classname="col-xs-6" :hint="lang('approved_template_hint')"

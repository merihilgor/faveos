<template>
  ...
  <div>
    ...
    <faveo-box :title="lang('facebook_app_settings')">
      ...
      <div slot="headerMenu" class="pull-right">
        <button @click.prevent="gotoPageSettingsPage" class="btn btn-primary">
      ...
      <div class="row" slot="actions">
        ...
        <button class="btn btn-primary btn-small myBtn" @click.prevent="submitter">

...
class FacebookAdminNavigationController
{
  ...
  public function getNavigationArray() : Collection
  {
    ...
    $this->injectNavigationIntoCollection($navigationArray, 'facebook_page_settings_nav', 'fa fa-facebook-square','facebook/settings','facebook/settings');
    $this->injectNavigationIntoCollection($navigationArray, 'facebook_security_settings_nav', 'fa fa-shield','facebook/security-settings','facebook/security-settings');

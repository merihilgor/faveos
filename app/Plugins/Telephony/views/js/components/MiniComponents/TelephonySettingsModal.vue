			...
			<div class="row">
				...
				<div class="col-xs-12">
					...
					<dynamic-select :label="lang('department')" :multiple="false" name="department" :prePopulate="true"
						classname="col-xs-6" apiEndpoint="/api/dependency/departments" :value="department" 
					...
					<dynamic-select :label="lang('helptopics')" :multiple="false" name="helptopic" :prePopulate="true"
						classname="col-xs-6" apiEndpoint="/api/dependency/help-topics" :value="helptopic" 
				...
				<div class="col-xs-12">
					...
					<div class="col-xs-12 form-group">
				      ...
				      <div class="input-group-btn">
				        ...
				        <button class="btn btn-default" @click="copyDeptUrl" title="Copy">
				...
				<div class="col-xs-12">
					...
					<div class="col-xs-12 form-group">
				      ...
				      <div class="input-group-btn">
				        ...
				        <button class="btn btn-default" @click="copyTopicUrl" title="Copy">

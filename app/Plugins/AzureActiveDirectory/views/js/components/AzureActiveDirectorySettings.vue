        ...
        <div v-if="hasDataPopulated">
            ...
            <faveo-box :title="lang('configuration_settings')" >
                ...
                <div class="row">
                    ...
                    <text-field :label="lang('tenant_id')" :value="tenant_id" type="text" name="tenant_id" :onChange="onChange" classname="col-xs-6" :required="true" id="tenant-id">
                    </text-field>
                </div>

                <div class="row">
                    <text-field :label="trans('app_id')" :value="app_id" type="text" name="app_id" :onChange="onChange" classname="col-xs-6" :required="true" id="app-id">
                    </text-field>

                    <text-field :label="trans('app_secret')" :value="app_secret" type="password" name="app_secret" :onChange="onChange" classname="col-xs-6" :required="true" id="app-secret">
                    </text-field>
                </div>

                <div class="row">
                    <text-field :label="trans('login_button_label')" :value="login_button_label" type="text" name="login_button_label" :onChange="onChange" classname="col-xs-6" id="login-button-label">
                    </text-field>

                    <text-field :label="trans('azure_redirect_uri')" :hint="trans('azure_redirect_uri_hint')" :value="basePath()+'/auth-token/callback'" type="text" name="login_button_label" :onChange="onChange" classname="col-xs-6" disabled="true">
                    </text-field>
                </div>

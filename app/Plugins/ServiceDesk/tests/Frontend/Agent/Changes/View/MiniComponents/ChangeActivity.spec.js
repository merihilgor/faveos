...
import ChangeActivity from '../../../../../../views/js/components/Agent/Changes/View/MiniComponents/ChangeActivity.vue';
...
describe('ChangeActivity',() => {
	...
	it('makes an API call', (done) => {
		...
		setTimeout(()=>{
			...
			expect(moxios.requests.mostRecent().url).toBe('/service-desk/api/change-log/1?page=1')
	...
	function stubRequest(status = 200,url = '/service-desk/api/change-log/1?page=1'){

...
import ContractActivity from '../../../../../../views/js/components/Agent/Contract/View/Mini/ContractActivity.vue';
...
describe('ContractActivity',() => {
	...
	const updateWrapper = () =>{
		...
		wrapper = mount(ContractActivity,{
	...
	it('makes an API call', (done) => {
		...
		setTimeout(()=>{
			...
			expect(moxios.requests.mostRecent().url).toBe('/service-desk/api/contract-log/1?page=1')
	...
	function stubRequest(status = 200,url = '/service-desk/api/contract-log/1?page=1'){

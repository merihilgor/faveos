...
import ProblemAssociatedAssets from '../../../../../../views/js/components/Problem/View/MiniComponents/Associates/ProblemAssociatedAssets.vue';
...
describe('ProblemAssociatedAssets', () => {

	beforeEach(()=>{

		wrapper = mount(ProblemAssociatedAssets,{
			
			stubs:['data-table','problem-asset-detach'],
  ...
  it("`responseAdapter` set detach, compName and change_id to the data property", () => {
    ...
    let responseAdpData = {
      "data": {
        "data": {
          "assets": [
            {"detach": true,"compName": "change","problem_id": 1},
          ],
          "total": 1
        }
      }
    }
    let responseAdpDataReturn = {"count": 1, "data": [{"problem_id": "", "compName": "", "detach": true}]}

...
import ProcurementTypeIndex from '../../../../views/js/components/Admin/ProcurementType/ProcurementTypeIndex.vue';
...
describe('ProcurementTypeIndex', () => {
    ...
    store = new Vuex.Store({
      ...
      getters
		...
		wrapper = mount(ProcurementTypeIndex,{
  ...
  it("`responseAdapter` set edit_url, delete_url to the data property", () => {
    ...
    let responseAdpDataReturn = 
      {"count": 1, "data": [
        {"edit_url": "undefined/service-desk/procurement/1/edit", "delete_url": "undefined/service-desk/api/procurement-mode/1", "id": 1}
      ]}

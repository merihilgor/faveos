...
import LicenseTypeIndex from '../../../../views/js/components/Admin/LicenseType/LicenseTypeIndex.vue';
...
describe('LicenseTypeIndex', () => {
  ...
  it("`responseAdapter` set edit_url, delete_url to the data property", () => {
    ...
    let responseAdpDataReturn = 
      {"count": 1, "data": [
        {"edit_url": "undefined/service-desk/license-types/1/edit", "delete_url": "undefined/service-desk/api/license-type/1", "id": 1}
      ]}

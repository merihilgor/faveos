...
<?php
        ...
        ?>
@section('meta-tags')
<meta name="title" content="{{Lang::get('ServiceDesk::lang.assets_lists-page-title')}}  :: {!! strip_tags($title_name) !!} ">
<meta name="description" content="{{Lang::get('ServiceDesk::lang.assets_inbox-page-description')}} ">

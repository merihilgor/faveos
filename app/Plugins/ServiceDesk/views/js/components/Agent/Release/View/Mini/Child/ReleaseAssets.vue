		...
		<modal v-if="showModal" :showModal="showModal" :onClose="onClose" :containerStyle="containerStyle">
			...
			<div slot="fields" id="static_select">
				...
				<div class="row">
					...
					<dynamic-select :label="trans('asset_types')" :multiple="false" name="asset_type_ids"
					...
					<dynamic-select :label="trans('used_by')" :multiple="false" name="used_by_ids"
					...
					<dynamic-select :label="trans('managed_by')" :multiple="false" name="managed_by_ids"
					...
					<dynamic-select :label="trans('organizations')" :multiple="false" name="org_ids"
...
<script type="text/javascript">
	...
	export default {
		...
		description : 'Release asset Modal component',
		...
		methods:{
			...
			onApply(){
				...
				let baseUrlForFilter = '/service-desk/api/asset-list?release_id='+this.releaseId+'&';
			...
			onSubmit(){
				...
				if(this.assetIds.length > 0){
					...
					axios.post('/service-desk/api/release/attach-assets/'+this.releaseId,data,config).then(res => {

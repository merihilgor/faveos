  ...
  <div>
    ...
    <transition name="modal">
      ...
      <ticket-detach-modal v-if="showModal" :onClose="onClose" :showModal="showModal" :ticketId="ticketId"
        :changeId="changeId" :type="ticket_type"> 
...
<script>
  ...
  import Vue from 'vue'
    ...
    name : 'changes-tickets-table',

		description : 'Changes tickets table page',

		props : {

      changeId : { type : String | Number, default : ''},

      componentTitle : { type : String, default : 'ChangeTickets'},
    },
        ...
        columns: ['ticket_number', 'subject', 'assigned', 'type','action'],

        options : {},

        apiEndPoint : '/service-desk/api/attached-ticket/change?change_id='+this.changeId,
    ...
    methods : {
      ...
      'ticket-detach-modal' : require('./TicketDetachModal.vue')
		}
	};
</script>

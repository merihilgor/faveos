	...
	<div> 
		...
		<modal v-if="showModal" :showModal="showModal" :onClose="onClose" :containerStyle="containerStyle">
			...
			<div slot="title" id="alert_top">
				...
				<alert componentName="attach-asset-modal"/>
...
<script type="text/javascript">
	...
	export default {
		...
		name : 'asset-attach-modal',

		description : 'Attach asset Modal component',
		...
		props:{
			...
			*/
			...
			alert : { type : String, default : 'attach-asset-modal' }
		...
		methods:{
			...
			onSubmit(){
				...
				if(this.assetIds.length > 0){
					...
					axios.post('/service-desk/api/ticket-attach-assets',data,config).then(res => {
						...
						errorHandler(err,'attach-asset-modal')		
					});
				} else {
		...
		components:{
			...
			'asset-list-with-checkbox' : require('./AssetListWithCheckbox.vue'),

...
@section('meta-tags')
<meta name="title" content="{{Lang::get('ServiceDesk::lang.releases_edit-page-title')}}  :: {!! strip_tags($title_name) !!} ">
<meta name="description" content="{{Lang::get('ServiceDesk::lang.releases_edit-page-description')}} ">
...
@section('PageHeader')
    <h1> {{Lang::get('ServiceDesk::lang.edit_release')}} </h1>
@stop
...
@section('content')
    ...
    <div id="app-sevicedesk">
        ...
        <release-create-edit></release-create-edit>
    </div>

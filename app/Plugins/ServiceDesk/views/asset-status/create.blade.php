...
?>
@section('meta-tags')
<meta name="title" content="{{Lang::get('ServiceDesk::lang.asset_statuses_create-page-title')}}  :: {!! strip_tags($title_name) !!} ">
<meta name="description" content="{{Lang::get('ServiceDesk::lang.asset_statuses_create-page-description')}} ">

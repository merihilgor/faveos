    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">{{Lang::get('ServiceDesk::lang.symptoms')}}</h4>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                       {!! Form::label('symptoms',Lang::get('ServiceDesk::lang.symptoms')) !!}
                       {!! Form::textarea('symptoms',$symptom,['class'=>'form-control','id'=>'ckeditor2']) !!}

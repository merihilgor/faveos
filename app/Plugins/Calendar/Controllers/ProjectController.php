...
class ProjectController extends Controller 
{
    ...
    {   
        ...
        return ($project->delete()) ? successResponse(trans('Calendar::lang.project_deleted')) : errorResponse(trans('Calendar::lang.project_not_deleted'));
    }
    ...
    public function edit($projectId,ProjectRequest $request)
    {
        ...
        return ($updatedRow) ? successResponse(trans('Calendar::lang.project_updated')) : errorResponse(trans('Calendar::lang.project_not_updated'));
    }

    public function indexAll()
    {
        return Project::with(['taskLists','tasks'])->get()->toArray();
    }

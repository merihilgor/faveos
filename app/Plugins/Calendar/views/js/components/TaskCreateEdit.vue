<template>
    <div>
        ...
        <div class="row">
            ...
            <text-field :label="lang('task_name')" :max="30"
            ...
            <div class="col-sm-6">
                ...
                <label class="radio-inline control-label">
                    <input type="radio" value="1" v-model="is_private" :disabled="disableRadioInput">{{lang('private')}}
                </label>
                <label class="radio-inline control-label">
...
<!--            <dynamic-select-->
<!--                name="due_alert" classname="col-sm-6"-->
<!--                :elements="elementsTaskAlert" :multiple="false"-->
<!--                :prePopulate="false" :label="lang('task_alert')"-->
<!--                :value="due_alert" :onChange="onChange"-->
...
<!--            />-->
        ...
        <div class="row">
            ...
            <dynamic-select
                    name="task_list_id" classname="col-sm-6"
                    apiEndpoint="tasks/tasklist/view" :multiple="false"
                    :label="lang('task_list')"
                    :value="task_list_id" :onChange="onChange"
                    :searchable="true"
            />
        ...
        <div class="row">
            ...
            <text-field rows="5" cols="1" :label="lang('task_description')"
                ...
                :required=required  id="task_description"
            />
            ...
            getTaskDetails() {
                ...
                axios.get('/tasks/get-task-by-id/'+this.taskId)
                    .then((res)=>{
                        ...
                        this.task_list_id = data.task_list

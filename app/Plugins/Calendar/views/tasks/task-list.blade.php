              ...
              <div class="box box-primary">
                  <div class="box-header with-border">
                      <div class="buttons-div">
                          <button class="btn btn-primary btn-sm" onclick="taskCreatePage()">
                              <span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;{!! Lang::get('Calendar::lang.create_task') !!}
                          </button>
                          <button class="btn btn-primary btn-sm" onclick="taskListPage()">
                              <span class="glyphicon glyphicon-th-list"></span>&nbsp;&nbsp;{!! Lang::get('Calendar::lang.list_view') !!}
                          </button>
                      </div>
                  </div>
                <div class="box-body">
  ...
  $(function(){
    ...
    $('#calendar').fullCalendar({
     ...
     events: function (start,end,timeZone, callback) {
        $.ajax({
            url: '{!! url("tasks/get-all-tasks-for-calendar?category=$category") !!}',
            type: 'GET',
            data: {},

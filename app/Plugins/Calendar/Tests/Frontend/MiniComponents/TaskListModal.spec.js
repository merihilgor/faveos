...
describe('TaskListModal',()=>{
    ...
    setTimeout(()=>{
    	...
    	expect(moxios.requests.mostRecent().url).toBe('/tasks/tasklist/edit/1')
    ...
    setTimeout(()=>{
    	...
    	expect(moxios.requests.mostRecent().url).toBe('/tasks/tasklist/create')
	...
	function createRequest(status = 200,url = '/tasks/tasklist/create'){
	...
	function editRequest(status = 200,url = '/tasks/tasklist/edit/1'){

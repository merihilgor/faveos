...
describe('TaskModal',()=>{
    ...
    setTimeout(()=>{
    	...
    	expect(moxios.requests.mostRecent().url).toBe('/tasks/project/edit/1')
    ...
    setTimeout(()=>{
    	...
    	expect(moxios.requests.mostRecent().url).toBe('/tasks/project/create')
	...
	function createRequest(status = 200,url = '/tasks/project/create'){
	...
	function editRequest(status = 200,url = '/tasks/project/edit/1'){

<div class="row">
    <div class="col-xs-8 form-group {{ $errors->has('department_status') ? 'has-error' : '' }}">
        ...
        {!! Form::select('department_status[]', [Lang::get('DepartmentStatusLink::lang.department-status') => $status], $departmentStatus, ['class' => 'form-control select2', 'id'=>'departmentStatus', 'style' => "width:100%", 'multiple' => 'true']) !!}
    </div>
</div>

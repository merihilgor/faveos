...
@if (count($errors) > 0)
        ...
        @endif
<section class="content-heading-anchor" ng-controller="migrateCtrl">
    <h1>
        {{Lang::get('migration::lang.migration')}}  
...
<div class="box box-primary">
    ...
    <div class="box-header with-border">
        <h4> {{Lang::get('migration::lang.migrate')}}  </h4>
        <!-- /.box-header -->
        <!-- form start -->
                ...
                <table class="table table-borderless">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="javascript:void(0)" class="btn btn-sm btn-primary" ng-click="migrate('{{$app}}')" ng-disabled="disabMig"><i class="fa fa-exchange" aria-hidden="true">&nbsp;&nbsp;</i>Migrate</a></td>
                        </tr>
                        <?php $i++;?>
                        @empty 
                        <tr>

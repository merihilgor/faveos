...
return [
    ...
    'purchase-confirmation-alert'                       => 'Purchase confirmation alert',
    'payment-approval-alert'                            => 'Approve payment alert',
    ...
    'shortcode_order_expriy_date_description'           => 'Expiry date of the order credits',
    ...
    'shortcode_invoice_link_for_agent_description'      => 'Link of invioce for agents to review',
    'shortcode_invoice_link_for_client_description'     => 'Link of invoice for clients to view',
    'shortcode_invoice_user_email_description'          => 'Email of the user for whom the invioce is raised',
    'shortcode_invoice_user_name_description'           => 'Full name of the user for whom the invioce is raised',
    'shortcode_invoice_paid_date_description'           => 'Date on which amount is paid for the invioce',
    'shortcode_invioce_amount_paid_description'         => 'Amount paid for the invoice',
    ...
    'shortcode_invioce_payable_amount_description'      => 'Amount to be paid for the invoice',
    ...
    'shortcode_invoice_id_description'                  => 'ID of the invioce',
    ...
    'template-purchase-notification'                    => 'This template is for notifying admins and agents about a successful purchase',
    'template-payment-approval'                         => 'This template is for notifying admins and agents to approve offline payement for an order.',
    'template-purchase-confirmation'                    => 'This template is for sending purchase confirmation to users',
    'template-send-invoice'                             => 'This template is for sending an invoice to users',
    'bill'                                              => 'Billing',

...
class SettingsController extends ActivateController
{
    ...
    public function renderSettingsBlock()
    {
        echo '<div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">'.trans('lang.bill').'</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-2 col-sm-6">
                                <div class="settingiconblue">
                                    ...
                                    <p class="box-title" >' . Lang::get('Bill::lang.options') . '</p>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-6">
                                <div class="settingiconblue">
                                    ...
                                    <p class="box-title" >' . Lang::get('Bill::lang.packages') . '</p>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-6">
                                <div class="settingiconblue">
                                    <div class="settingdivblue">
                                        <a href="' . url('bill/payment-gateways') . '" onclick="sidebaropen(this)">
                                            <span class="fa-stack fa-2x">
                                                <i class="fa fa-cc-paypal fa-stack-1x"></i>
                                            </span>
                                        </a>
                                    </div>
                                    <p class="box-title" >' . Lang::get('Bill::lang.payment_gateway') . '</p>
                                </div>
                            </div>
                        </div>
                    <!-- /.row -->
    ...
    public function renderAlertAndNoticeSettings($alerts, $settings, $persons = ['admin', 'agent', 'client'])
    {
        ...
        echo '<div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">'.trans('Bill::lang.'.$settings).'</h3>
                    </div>
                    <div class="box-body">
    ...
    public function showInvoiceTabOnTopBar() :void
    {
        if(commonSettings('bill', 'show_packages')) {
            ...
            echo '<li @yield("Invoice") data-toggle="tooltip" data-placement="bottom" title="'.trans('Bill::lang.pending_invoices').'"><a href="'.url('billing/invoices').'?status=0" style="direction:ltr;unicode-bidi: embed;"><i class="fa fa-file-pdf-o"></i><span class="label label-danger" id="count">'.$count.'</span></a></li>';
        }
    }
}

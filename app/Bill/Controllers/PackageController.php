...
class PackageController extends Controller {
    ...
    public function store(PackageRequest $request)
    {
        ...
        try {
            ...
            if (Input::file('package_pic')) {
                ...
                $name = Input::file('package_pic')->getClientOriginalName();
                // fetching upload destination path
                $destinationPath = public_path('uploads' . DIRECTORY_SEPARATOR . 'packages');
                ...
                Input::file('package_pic')->move($destinationPath, $fileName);
                // saving filename to database
                Package::where('id', $packageId)->update(['package_pic' => $fileName]);
            }
            if ($request->kb_link) {
    ...
    public function editApi($packageId)
    {
        try {
            ...
            $packageInfo['package_pic'] = ['name' => $packageInfo['package_pic']];
    ...
    public function getPackageInfo($packageId)
    {
        try {
            ...
            $path = $packageInfo['package_pic'] ? url('/uploads/packages/' . $packageInfo['package_pic']) : null;
            $packageInfo['package_pic'] = (['name' => $packageInfo['package_pic'], 'path' => $path]);

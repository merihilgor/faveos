...
<form id="Form">
    ...
    <div class="box-header with-border">
            <h3 class="box-title">{{ Lang::get('lang.edit_bill_settings') }}</h3>
        </div>
    <div class="box-body">
<?php
  if($currency){
...
?>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="form-group col-md-6 {{ $errors->has('show_packages') ? 'has-error' : '' }}">
          ...
          <div class="col-md-12">
            <div class="form-group col-md-6 {{ $errors->has('allowWithoutPackage') ? 'has-error' : '' }}">
          ...
          <div class="form-group col-md-6 {{ $errors->has('trigger_on') ? 'has-error' : '' }} hide" id="trigger" style="display: none;">
          ...
          <div class="col-md-12">
            <div class="form-group col-md-6 {{ $errors->has('invoice-due') ? 'has-error' : '' }}">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
         ...
         <div class="well" style="display: none"></div>
          ...
          <div class="col-sm-12" ng-repeat="bill in billingType">
           <div class="col-sm-5">
             ...
             <span ng-show="loado@{{$index}}" style="width:10%"><img src="{{assetLink('image','25')}}" style="width:20px;height:20px"></span>
           </div>
           <div class="col-sm-6">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-primary" data-dismiss="modal"><i class="fa fa-floppy-o">&nbsp;&nbsp;</i>{!!Lang::get('lang.save')!!}</button>
        </div>
      </div>
...
<div class="showType" style="display: none">
  ...
  <div style="text-align: right;">
   <button type="button" class="btn btn-primary" data-toggle='modal' data-target='#typeModal'><i class="fa fa-refresh">&nbsp;&nbsp;</i>{!!Lang::get('lang.update')!!}</button>
  </div>
</div>
        <!-- /.box-body -->
    </div>
        ...
        $scope.saveBill=function(y){
             ...
             $http.post('{{route("bill.settings.post")}}?'+serialize+'&currency='+$scope.selectedCurrencyCode,bilingtype).success(function(data){
              ...
              if(data.error!=undefined){
                    $('.wello').css('display','block');      
                    $('.wello').html('<div class="alert alert-danger alert-dismissable"><i class="fa fa-ban"></i>&nbsp'+data.error+'<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button></div>');
                    window.scrollTo(0, 0);
                    y.currentTarget.innerHTML="<i class='fa fa-floppy-o'>&nbsp;&nbsp;</i>{!! Lang::get('lang.save') !!}";

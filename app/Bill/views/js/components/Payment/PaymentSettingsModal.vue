	...
	<modal v-if="showModal" :showModal="showModal" :onClose="onClose" 
		...
		<div v-if="!loading" slot="fields">
			...
			<div class="row">
				...
				<div class="col-md-12">
					<text-field :label="lang('name')" :value="name" 
						...
						:onChange="onChange" classname="col-xs-5">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div v-for="(field,index) in extraSwitchFields" :key="field.index" class="col-xs-2"> 
		...
		<div slot="controls">
			...
			<button type="button" id="submit_btn" @click="onSubmit()" class="btn btn-primary" :disabled="isDisabled">
				...
				<i class="fa fa-refresh" aria-hidden="true"></i> {{lang('update')}}
			</button>
		</div>
	</modal>
</template>

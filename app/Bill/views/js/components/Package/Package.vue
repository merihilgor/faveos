	...
	<div>
		...
		<div class="box box-primary" v-if="hasDataPopulated === true">
			...
			<div class="box-body">
				...
				<div class="row">
					...
					<text-field label="Name" :value="name" type="text" 
						name="name" :onChange="onChange" classname="col-xs-4" 
						:required="true">
						
					</text-field>

					<number-field :label="lang('display_order')" :value="display_order" 
						name="display_order" classname="col-xs-4"
          ...
          <dynamic-select :label="lang('departments')" :multiple="true" name="departments" :prePopulate="true"
            classname="col-xs-4" apiEndpoint="/api/dependency/departments" :value="departments" :onChange="onChange">
				...
				<div class="row">
					...
					:onChange="onChange" classname="form-group col-xs-3" >
				...
				<div class="row">
					...
					<number-field v-else :label="lang('incident_credit')" :value="allowed_tickets" 
						name="allowed_tickets" classname="col-xs-6"
            :onChange="onChange" type="number" :required="true">
            
          </number-field>

					<number-field :label="lang('price')" :value="price" 
						name="price" classname="col-xs-6"
            :onChange="onChange" type="number" :required="true">
				...
				<div class="row">
					...
					<text-field :label="lang('terms_conditions_page_link')" :value="kb_link" 
						...
						:onChange="onChange" classname="col-xs-6">
							
					</text-field>

					<file-upload :label="lang('image')" :value="package_pic" name="package_pic" 
					:onChange="onChange" classname="col-xs-6" accept="image/*">
					</file-upload>
				</div>
		...
		methods : {
			...
			onSubmit() {
				...
				if (this.isValid()) {
					...
					fd.append('package_pic', this.package_pic)

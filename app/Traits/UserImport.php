...
trait UserImport
{
     ...
     * @var string[]
     */
    public static $userAttributes = ['user_name','email','phone_number','first_name','last_name','role','import_identifier'];
    ...
    {
        foreach (FormField::getUserCustomFieldList() as $formField) {
            try {
    ...
    public function getFaveoAttributeList()
    {
        ...
        $customAttributes = FormField::getUserCustomFieldList()
            ->map(function($element){
                $attributeObject = (object)[];

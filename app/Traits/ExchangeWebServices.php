    ...
    if($attachments && $attachments->FileAttachment){
      ...
      foreach ($attachmentResponseMessages as $attachmentResponseMessage) {
          ...
          foreach ($attachments as $attachment) {
              ...
              $formattedAttachment->filePath = "$this->tempAttachmentPath/" . $formattedAttachment->fileName;
              ...
              file_put_contents($formattedAttachment->filePath, $attachment->Content);
          }
      }
    ...
    if(count($attachmentObjects)){
      ...
      foreach ($attachmentObjects as $attachmentObject) {
        ...
        if(isset($attachmentObject['file_name'])){
          ...
          $filePath = $attachmentObject['path'] . DIRECTORY_SEPARATOR . $attachmentObject['name'];

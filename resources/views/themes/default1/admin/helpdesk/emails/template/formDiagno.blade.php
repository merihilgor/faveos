...
<form method="POST" id="Form" action="{!! route('postdiagno') !!}">
    ...
    <div class="box box-primary">
        ...
        <div class="box-footer">
            <div class="row">
                ...
                <div class="col-md-2">
                  <button type="submit" class="btn btn-primary" id="submit" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'>&nbsp;</i> Sending..."><i class="fa fa-paper-plane">&nbsp;&nbsp;</i>{!!Lang::get('lang.send')!!}</button>
                </div>            
            </div>

...
<div class="box box-primary">
    <div class="box-header with-border">
        ...
        <a href="{{ route('department.profile.show', $departments->id) }}" class="btn btn-primary pull-right btn-sm">
                        <i class="fa fa-eye" style="color:white;"> </i>&nbsp;&nbsp;
                    {{Lang::get('lang.view')}}</a>
    </div>
    <div class="box-body">
        ...
        <div class="row">
            ...
            <!-- account status -->
            <div class="col-xs-3 form-group {{ $errors->has('account_status') ? 'has-error' : '' }}">
            ...
            <!-- sla -->
           <div class="col-xs-3 form-group {{ $errors->has('business_hour') ? 'has-error' : '' }}">
          ...
          <!-- manager -->
        <div class="row">
            <div class="col-xs-8 form-group {{ $errors->has('manager') ? 'has-error' : '' }}">

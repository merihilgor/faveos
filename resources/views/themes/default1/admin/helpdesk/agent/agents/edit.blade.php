...
<?php
        ...
        ?>
@section('meta-tags')
<meta name="title" content="{!! Lang::get('lang.agent_edit-page-title') !!} :: {!! strip_tags($title_name) !!} ">
<meta name="description" content="{!! Lang::get('lang.agent_edit-page-description') !!}">
@stop
@section('custom-css')
<!-- Latest compiled and minified CSS -->
<link rel="stylesheet" href="{{assetLink('css','bootstrap-select')}}">
<link rel="stylesheet" href="{{assetLink('css','select2')}}">
<!--select 2-->
<link href="{{assetLink('css','lang')}}" rel="stylesheet" media="none" onload="this.media='all';"/>

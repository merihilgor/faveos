    ...
    <div class="col-md-3">
        <div class="box box-primary" >
            ...
            <div class="box-body ">
                <div>
                    <center>
                        <img src="{{assetLink('image','team')}} " class="img-circle" alt="User Image" style="border:3px solid #CBCBDA;padding:3px;">  
         ...
         <div class="box-footer">
            ...
            <span class="pull-right" title="{{$team_lead_name}}">{{str_limit($team_lead_name,10)}}</span>
    ...
    <div class="col-md-9">
      <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">{!! Lang::get('lang.team_members') !!}</h3>
        </div>

...
<div class="box box-primary">
    ...
    <div class="box-header with-border">
        <h3 class="box-title">{!! Lang::get('lang.list_of_source') !!}</h3>
        <div class="box-tools pull-right">
            <div class="box-tools pull-right">

             <a href="{{url('source/create')}}" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;{{Lang::get('lang.create_source')}}</a>

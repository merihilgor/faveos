...
<div class="box box-primary">
    ...
    <div class="box-body table-responsive"style="overflow:hidden;">
        ...
        <div class="row">
                <div class="col-md-12">
                <p>{{ trans('lang.copy-cron-command-description') }}</p>
                </div>
        </div>
...
{!! Form::model($condition,['url' => 'post-scheduler', 'method' => 'PATCH','id'=>'Form']) !!}
        ...
        <div class="col-md-6">
             <div class="info-box">
                ...
                <span class="info-box-icon bg-aqua" style="padding-top: 0px"><i class="{{$job['icon']}}"></i></span>
                <div class="info-box-content">
                    ...
                    <div class="col-md-6" id="{{$job['job']}}-command-block" @if(!$job['active']) style="display: none;" @endif>

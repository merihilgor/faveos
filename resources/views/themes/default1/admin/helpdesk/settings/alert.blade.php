...
<div class="box box-primary">
    <div class="box-header">
        <h4 class="box-title">
            {{Lang::get('lang.alert_notices_setitngs')}}</h4> <button type="submit" class="btn btn-primary pull-right" id="submit" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'>&nbsp;</i>{!! Lang::get('lang.saving') !!}"><i class="fa fa-floppy-o">&nbsp;&nbsp;</i>{!!Lang::get('lang.save')!!}</button>
...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">{{Lang::get('lang.daily_report')}}</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <div class="box-body">
                    <div class="form-group">
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">{{Lang::get('lang.rating-mail')}}</h3>
                </div>
                <div class="box-body">
                    <div class="form-group">
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">{{Lang::get('lang.rating-confirmation-label')}}</h3>
                </div>
                <div class="box-body">
                    <div class="form-group">
    ...
    <div class="col-md-6">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">{{Lang::get('lang.registration_confirmation_and_verification')}}</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <div class="box-body">
                    <div class="form-group">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">{{Lang::get('lang.email_verify')}}</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <div class="box-body">
                    <div class="form-group">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">{{Lang::get('lang.browser-notification')}}</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <div class="box-body">
                    <div class="row">
        ...
        @if(isPlugin('LimeSurvey'))        
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Lime Survey</h3>
                    </div>
                    <div class="box-body">
                        <div class="form-group">
                            {!! Form::label('status', Lang::get('lang.ticket-status')) !!}&nbsp;&nbsp;
...
<script type="text/javascript">
    $(function(){
     ...
     function validate(x){
                    ...
                    setTimeout(function(){
                        $(document).find('#submit').html('<i class="fa fa-floppy-o">&nbsp;&nbsp;</i> Save');

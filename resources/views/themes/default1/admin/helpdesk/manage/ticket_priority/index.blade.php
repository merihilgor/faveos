...
<div class="box-header with-border">
        <h2 class="box-title">{!! Lang::get('lang.list_of_ticket_priority') !!}</h2><a href="{{route('priority.create')}}" class="btn btn-primary pull-right"><span class="glyphicon glyphicon-plus"></span> &nbsp;{{Lang::get('lang.create_ticket_priority')}}</a></div>

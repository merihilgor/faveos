...
<div class="box box-primary">
    <div class="box-header with-border">
        <h2 class="box-title">{!! Lang::get('lang.list of ticket types') !!}</h2><a href="{{route('ticket.type.create')}}" class="btn btn-primary pull-right"><span class="glyphicon glyphicon-plus"></span> &nbsp;{{Lang::get('lang.create_ticket_type')}}</a></div>
 <div class="box-body">

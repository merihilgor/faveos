...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">{{Lang::get('lang.list_of_help_topics')}}</h3>
    ...
    <div class="box-body">
        ...
        <thead>
            ...
            @if($sys_help_topic->help_topic == $topic->id)
                   <a href="{{route('helptopic.edit',$topic->id)}}" class="btn btn-primary btn-xs "><i class="fa fa-edit" style="color:white;">&nbsp;</i>
                         {!! Lang::get('lang.edit') !!}</a>&nbsp;
                   <a href='#' class='btn btn-primary btn-primary btn-xs' disabled='disabled' ><i class='fa fa-trash' style='color:white;'>&nbsp;</i>&nbsp;{!! Lang::get('lang.delete') !!} </a>
                </div>
                   {!! Form::close() !!}
            @else
                   ...
                   <?php
                    ...
                    ?> 
                      <a href="{{route('helptopic.edit',$topic->id)}}" class="btn btn-primary btn-xs "><i class="fa fa-edit" style="color:white;"> </i> &nbsp;{!! Lang::get('lang.edit') !!}</a>&nbsp;&nbsp;{!!$confirmation!!}
                 </div>
                  {!! Form::close() !!}
            @endif
              </td>

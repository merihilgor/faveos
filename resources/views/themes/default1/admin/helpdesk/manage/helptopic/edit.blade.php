...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">{{Lang::get('lang.edit_help_topic')}}</h3>
    </div>
    <div class="box-body">
           ...
           @endif
            ...
            <!-- Department:    Drop down: value Department form table -->
                    <div class="col-md-6 form-group {{ $errors->has('linked_department') ? 'has-error' : '' }}">
                        {!! Form::label('linked_departments',Lang::get('lang.linked_department')) !!} <span class="text-red"> *</span>&nbsp;&nbsp;<a href="#" data-toggle="tooltip" title="{!! Lang::get('lang.linked-department-tooltip-message') !!}"><i class="fa fa-question-circle" style="padding: 0px;"></i></a>

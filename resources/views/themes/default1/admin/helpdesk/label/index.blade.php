...
<div class="box-header with-border">
        <div class="box-title">
            <h4>{!!Lang::get('lang.list_of_labels')!!}</h4>


        </div>
        <a href="{{url('labels/create')}}" class="btn btn-primary pull-right"><span class="glyphicon glyphicon-plus"></span> &nbsp; {!!Lang::get('lang.create_label')!!}</a>

    ...
    <div class="box-body">
        ...
        <table id="example2" class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @if($queue->name === 'Database')
                            <a data-toggle="tooltip" title="{{ trans('lang.queue_page_instructions', ['name' => 'Database']) }}" target="_blank" href='https://support.faveohelpdesk.com/show/how-to-configure-different-queues-list-to-send-out-emails-from-faveo' ><i class='fa fa-info-circle'>&nbsp;&nbsp;</i></a>
                        @elseif($queue->name === 'Redis')
                            <a data-toggle="tooltip" title="{{ trans('lang.queue_page_instructions', ['name' => 'Redis']) }}" target="_blank" href='https://support.faveohelpdesk.com/show/install-and-configure-redis-supervisor-and-worker-for-faveo-on-centos-7' ><i class='fa fa-info-circle'>&nbsp;&nbsp;</i></a>
                        @endif
                    </td>
            ...
            <div class="row">
                ...
                <div class="col-md-1">
                    <span style="font-size: 20px; pointer-events: initial; cursor: pointer;" id="copyBtn" title="{{trans('lang.verify-and-copy-command')}}" onclick="verifyPHPExecutableAndCopyCommand()"><i class="fa fa-clipboard"></i></span>

...
<html>
    <head>
        ...
        <link href="{{asset("lb-faveo/plugins/fullcalendar/fullcalendar.print.min.css")}}" rel="stylesheet" type="text/css" media='print' />
        <link href="{{asset("lb-faveo/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css")}}" rel="stylesheet" type="text/css" />
        <!-- Theme style -->
        <link href="{{asset("lb-faveo/dist/css/app.min.css")}}" rel="stylesheet" type="text/css" />
        <link href="{{asset("lb-faveo/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css")}}" rel="stylesheet" type="text/css" />
...
?>
        <footer id="colophon" class="site-footer" role="contentinfo">
			...
			<div class="clearfix"></div>
                    ...
                    <!-- Slimscroll -->
					<script src="{{asset("lb-faveo/dist/js/superfish.min.js")}}" type="text/javascript"></script>
                    <script src="{{asset("lb-faveo/dist/js/mobilemenu.min.js")}}" type="text/javascript"></script>
                    <script src="{{asset("lb-faveo/dist/js/know.min.js")}}" type="text/javascript"></script>

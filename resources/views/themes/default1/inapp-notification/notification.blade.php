...
<li class="dropdown notifications-menu"  ng-controller="MainCtrl" id="MainCtrl">
    <a href="#" class="dropdown-toggle notific" data-toggle="dropdown" ng-click="fbNotify()" title="In app Notifiaction" style="padding: 15px">
        <i class="fa fa-bell-o"></i>
        <span class="label label-warning" ng-bind="notiNum" style="right: 13px"></span>
    </a>
    <ul class="dropdown-menu" style="background: #fff;border: 1px solid rgba(100, 100, 100, .4);border-radius: 0 0 2px 2px;box-shadow: 0 3px 8px rgba(0, 0, 0, .25);color: #1d2129;overflow: visible;position: absolute !important;width: 430px !important;z-index: -1;">
        ...
        <li>
            ...
            <div>
                <ul class="list-group" style="outline: none;overflow-x: hidden;overflow-y: auto; height: 425px;margin-bottom: 0px;width: 100%" when-scrolled="loadApi()">
                        ...
                        <a href="javascript:void(0)" class="link" alt="" style="color: #1d2129;display: block;padding: 6px 30px 5px 12px;position: relative;" ng-click="newTab(noti.url,noti.id)">
                            <div class="col-sm-12">
                                <div class="col-sm-2" style="padding-right: 0px;padding-left: 0px;">
                                    <img  alt="" class="notiimg img-circle" ng-src="@{{noti.requester.profile_pic}}" onerror="this.src='{{assetLink('image','contacthead')}}'" style="display: block;height: 44px;margin-right: 12px;width: 44px;">
                                </div>               

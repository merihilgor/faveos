...
@section('content')
    <div class="wc-setup-content" ng-app="myApp">
        ...
        <h1 style="text-align: center;">Faveo Helpdesk License Code</h1>
        ...
        <form action="{{URL::route('final')}}" method="post" id='serail-verification'>
          ...
          <p ng-bind="user"></p>
            ...
            <p>You can find your license code in our billing portal <a href="https://billing.faveohelpdesk.com" target="_blank">billing.faveohelpdesk.com</a></p>
            <!-- <br> -->

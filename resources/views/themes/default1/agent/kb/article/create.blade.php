...
<?php
 ...
 ?>
@section('meta-tags')
<meta name="title" content="{!! Lang::get('lang.article_create-page-title') !!} :: {!! strip_tags($titleName) !!} ">
<meta name="description" content="{!! Lang::get('lang.article_create-page-description') !!}">
@stop   

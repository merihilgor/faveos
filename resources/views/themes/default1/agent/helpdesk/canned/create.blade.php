...
?>
@section('meta-tags')
<meta name="title" content="{!! Lang::get('lang.canned_response_create-page-title') !!} :: {!! strip_tags($titleName) !!} ">
<meta name="description" content="{!! Lang::get('lang.canned_response_create-page-description') !!}">

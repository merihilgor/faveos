...
<div class="box box-primary">
    <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
            <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#create" title="Create" id="2create"><span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;{{Lang::get('lang.create_template')}}</button>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @if($set->active == 1 && $set->id == 1)
                           <button class="btn btn-primary btn-xs disabled" data-toggle="modal" data-target="">{!! Lang::get('lang.activate_this_set') !!}</button>&nbsp;&nbsp;
                        @elseif ($set->active == 1 && $set->id != 1)
                            <div class="btn-group">
                                <a href="{{url('activate-templateset/'.$set->name)}}" class="btn btn-primary btn-xs">{{Lang::get('lang.deactivate_this_set')}}</a>&nbsp;
                            </div>
                        @else
                            <div class="btn-group">
                                <a href="{{url('activate-templateset/'.$set->name)}}" class="btn btn-primary btn-xs">{{Lang::get('lang.activate_this_set')}}</a>&nbsp;
                            </div>                   
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-default pull-left" data-dismiss="modal"><i class="fa fa-times" aria-hidden="true">&nbsp;&nbsp;</i>{!! Lang::get('lang.close') !!}</button>
                                            ...
                                            <a href="{{$url}}" class="btn btn-danger" onclick="clickAndDisable(this);"><i class="fa fa-trash" aria-hidden="true">&nbsp;&nbsp;</i>{!! Lang::get('lang.delete') !!}</a>
                                    </div>
                                </div> 
                            </div>
                            <script>

...
Vue.component('ticket-form', require('components/Common/Form/TicketForm.vue'));
...
Vue.component('user-form', require('./components/Common/Form/UserForm.vue'));

Vue.component('organisation-form', require('./components/Common/Form/OrganisationForm.vue'));

<template>
	...
	<div id="user_list">
		...
		<div class="box box-primary user-table">
			...
			<div class="box-header with-border">
				...
				<div class="row">
					...
					<div class="col-md-4">
						...
						<h4 class="box-title" id="box-title-1">{{lang('list_of_users')}}</h4>

					</div>

					<div class="col-md-8">

						<a class="btn btn-primary add-user round-btn" :href="basePath()+'/user/create'">

							<span class="glyphicon glyphicon-plus"> </span> &nbsp;{{lang('create_user')}}
						</a>

						<a :href="basePath()+'/user-export'" class="btn btn-default pull-right round-btn">

							<span class="glyphicon glyphicon-send"></span> &nbsp;{{lang('export')}}
						</a>

						<a class="btn btn-primary pull-right round-btn" @click="toggleFilterView" id="filter_btn">

							<span class="glyphicon glyphicon-filter" id="user-filter"></span>
						</a>
					</div>
				</div>
			</div>

			<div class="box-body" id="my_user">

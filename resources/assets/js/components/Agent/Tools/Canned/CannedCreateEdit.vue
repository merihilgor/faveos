		...
		<div class="box box-primary" v-if="hasDataPopulated === true">
			...
			<div class="box-body">
				...
				<div class="row">
					...
					<add-media :attachments="attachments" :inlineFile="inline" :description="message" :classname="classname" name="message"
						:show_error="show_err" :onAttach="getAttachments" :onInline="getInlineImages" :onInput="onChange" page_name="canned" chunkApi="/chunk/upload/public" filesApi="/media/files/public">
				...
				<div class="row">
					...
					<dynamic-select v-if="share" :label="lang('departments')" :multiple="true" name="departments" :required="true"
						 classname="col-xs-6" apiEndpoint="/api/dependency/departments" :value="departments" 
						:onChange="onChange">
				...
				<button type="button" v-on:click="onSubmit()" :disabled="loading" class="btn btn-primary canned-btn">

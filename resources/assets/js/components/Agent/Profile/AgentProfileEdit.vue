			...
			<div class="box box-primary">
				...
				<div class="box-body">
					...
					<div class="row">
						...
						<number-field :label="lang('ext')" :value="ext" name="ext" classname="col-xs-3"
							:onChange="onChange" type="number">
									
						</number-field>

						<number-field :label="lang('work_phone')" :value="phone_number" name="phone_number" classname="col-xs-9"
							:onChange="onChange" type="number">
					...
					<ck-editor :value="agent_sign" type="text" :onChange="onChange" name="agent_sign" :label="lang('agent_sign')"
						classname="" :lang="'en'">
		...
		<div class="col-md-6" v-if="hasDataPopulated">
			...
			<div class="box box-primary">
				...
				<div class="box-header with-border">
					...
					<h3 class="box-title">{{lang('2fa_setup')}}</h3>

	...
	<div id="tickets-index">
		...
		<alert componentName="inbox"></alert>
			...
			<faveo-box :title="lang('tickets')">
				...
				<a slot="headerMenu" class="text-muted pull-right refresh_a" @click="refreshIndex" 
				...
				<div class="inbox-new" id="inbox">
					...
					<div class="mailbox-messages mailinbox">
						...
						<ticket-filter v-on:filter="setFilter" :tableHeader="selectedColor"></ticket-filter>

						<div class="search-filter pull-right" id="search">
						...
						<div class="row">
							...
							<div  class="col-md-12 col-sm-12 col-xs-12" id="ticket-list-body">
							...
							<div v-if="!loading" class="col-md-12 col-sm-12 col-xs-12">
								...
								<table id="tickets-expanded" class="table table-responsive">
									...
									<tbody v-else>
										...
										<p class="text-center no-ticket-found">{{lang('no-ticket-found')}}</p>
									</tbody>
								</table>
							</div>
							...
							<div v-if="!loading" class="col-md-12 col-sm-12 col-xs-12">
								...
								<uib-pagination id="ticket-page" v-if="ticketResponse.total > 10" :total-items="ticketResponse.total" 
									v-model="pagination" :max-size="5" class="pagination pull-right" :boundary-links="true" :items-per-page="perpage" @change="pageChanged()">

			...
			<div>
				...
				<div class="form-group col-md-12">
					...
					<static-select :label="lang('select-pparent-ticket')" strlength="30"  :elements="parentTickets"
						name="parentTicket" :value="parentTicket" classname="col-xs-4" :onChange="onChange" 
						:required="true">
					</static-select>
		...
		methods:{
			...
			onChange(value, name){
				...
				if(name === 'parentTicket'){
					...
					this.title = this.parent_tickets.find(x => x.id == value).value;
				}
			},

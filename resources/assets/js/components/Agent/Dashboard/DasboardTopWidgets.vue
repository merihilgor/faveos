<template>
	<div>
		<div v-if="!dataWidgetData" class="row">
			<div class="col-md-3 col-sm-6 col-xs-12" v-for="i in topWidgetCount" :key="i">
				<div class="data-widget-box-skeleton">
				</div>
			</div>
		</div>
		<data-widget v-if="dataWidgetData && hasDataFetched" :data-widget-data="dataWidgetData" :widget-class="['col-md-3', 'col-sm-6', 'col-xs-12']"/>
	</div>
</template>

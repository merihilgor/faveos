			...
			<div id="content" class="site-content col-md-12 " >
				...
				<form-helper v-if="updateEmail">
					...
					<div slot="fields" :class="{align1 : lang_locale === 'ar'}">
						...
						<text-field v-if="!loading" label="Email" :value="email_address" type="email" name="email_address" :keyupListener="triggerEvent" :onChange="onChange" classname="" :required="true"></text-field>
					</div>
	...
	export default {
	    ...
	    onSubmit() {
	      ...
	      if (this.isValid()) {
	      	...
	      	this.$Progress.start();
					...
					const data = { oldEmail: this.getVerifyEmail, newEmail: this.email_address }
	    ...
	    initialState(){
			...
			resendLink(){
				...
				const data = { oldEmail: this.getVerifyEmail }

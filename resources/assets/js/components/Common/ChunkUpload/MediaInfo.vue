		...
		<div class="col-sm-12">
			...
			<div class="col-sm-6">                 
				...
				<template v-else>
					...
					<img v-else-if="mediaObj.type=='audio'" :src="basePath()+'/themes/default/common/images/audio1.png'" 
					...
					<img v-else :src="basePath()+'/themes/default/common/images/common.png'" class="preview-img" width="180px"/>

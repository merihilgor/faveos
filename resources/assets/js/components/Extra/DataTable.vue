<template>
	<div id="datatable">
		...
		<v-server-table v-if="showTable" ref="table" :url="endPoint" :columns="columnArray" :options="optionsObj" @error="onError" :name="scroll_to" @loaded="onLoaded" @pagination="onPage" :style="styleObj">
      ...
      <template v-if="isLoading" slot="afterTable">
        <custom-loader loaderType='clip-loader' :color="color">
			...
			<div v-if="!showTable && error_message" class="callout callout-danger">

<template>
	<form-field-template  :classname="classname" :label="lang('mobile_number')" :name="name">
	...
	methods: {
		...
		*/
		countryDetails(codes) {
			...
			if (this.countryCode) { // If parent component has countryCode
		...
		getCountryCodes() {
			axios
		      .get("api/dependency/country-codes", {
		        params: {
							meta: true,
							limit: 'all'
		        }

<template>
	...
	<form-field-template :label="label" :labelStyle="labelStyle" :name="name" :classname="classname" :hint="hint" 
		...
		<div>
			...
			<h4 class="profile-username text-center" :style="labelCss">{{label}}</h4>
		</div>  

		<div class="text-center">
			
			<a class="btn btn-primary btn-xs text-center" :disabled="is_default" data-toggle="modal"  @click="$refs.fileInput.click()"> 
				<i v-if="!buttonName" class="fa fa-exchange"></i>

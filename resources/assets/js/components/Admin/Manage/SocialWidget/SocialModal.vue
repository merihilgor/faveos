 ...
 <text-field :label="lang('Link')"  :onChange="onChange" :value="value" type="URL" name="value" 
        ...
        <!-- TODO add modal box content here -->
			...
			<div slot="controls">
				...
				<button  type="button" id="submit_btn" @click="onSubmit()" class="btn btn-primary" ><i :class="{'fa fa-save': !loading, 'fa fa-spinner fa-spin': loading}" aria-hidden="true"></i> {{lang('update')}}</button>				

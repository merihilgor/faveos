	...
	<div>
		...
		<modal v-if="deletePopup" :showModal="deletePopup" :onClose="onCloseModal">
			...
			<div slot="controls">
				...
				<button type="button" @click = "onSubmitDelete()" class="btn btn-danger">
					...
					<i class="fa fa-trash" aria-hidden="true"></i> {{lang('submit')}}
				</button>
			</div>
		</modal>
			...
			<div class="col-md-12">
				...
				<div class="col-md-5 d_flex">
					...
					<div class="col-md-1 text-right" id="mt8">
						...
						<span class="fa fa-trash faveo-trash" @click="removeField(field.id,index)">

						</span>
						
					</div>

					<span class="col-xs-2" id="mt8">{{beforeLabel}}</span>
					...
					<span class="col-xs-1" id="mt8">to</span>
				</div>
				...
				<dynamic-select :label="lang('type')"
					...
					:multiple="true" classname="col-xs-3"
					strlength="20"
				...
				<dynamic-select :label="lang('agents')"
					...
					:multiple="true"
					classname="col-xs-4" strlength="25"
		...
		<template>
          ...
          <button @click="addField" type="button" class="btn btn-default form-control">
          	...
          	<i class="fa fa-plus" aria-hidden="true"></i>  &nbsp; {{lang('add_new_rule')}}
          </button>
      </div>  
		</template>
	</div>

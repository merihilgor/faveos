<template>
  <div>
    <div class="col-md-8" style="padding-top: 10px;">
      ...
      <tool-tip :message="lang('api_endpoint')" size="small"></tool-tip>
...
export default {
  ...
  beforeMount() {
    this.apiInfoObj = FORM_BUILDER_UTILS.getApiInfoObj(this.formFieldData.api_info);
  },

  methods: {

    onChange: _.debounce(function () {
      this.updateApiInfo(FORM_BUILDER_UTILS.getApiInfoString(this.apiInfoObj))
		}, 350),

<template>
  <div id="main-div">
    ...
    <faveo-box :title="lang('list_of_agents')">

      <div class="pull-right" slot="headerMenu" >
        <a id="advance-filter-btn" class="btn btn-primary" @click="toggleFilterView" data-toggle="tooltip" data-original-title="Filter Agents">
          <span style="padding-right: 5px;" class="fa fa-filter" ></span></a>
        <a id="add-agent-link" class="btn btn-primary" :href="base+'/agents/create'">
          <span style="padding-right: 5px;" class="fa fa-user-plus"
            aria-hidden="true"></span>{{lang('create_agent')}}</a>
      </div>

    ...
    window.eventHub.$on( eventName, (data) => {
        ...
        setTimeout(()=>{
          ...
          if(container !== null && document.getElementById(componentName) === null){
            ...
            // todo: needs refactor
              // approach, creating a different container for each instance. Some pattern is needed
...
//==============================================================================================================
// Adding custom validation messages from our language file instead of vee-validate

...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // put some condition that if seeder was already run that don't run
        // for that just check the database for system table, if entry is not there then make the call
        // REASON : there will be someone who is going to upgrade from some version before 48,
        // he doesn't have to run this seeder because these are covered in sql files
        if(System::first()){
          return;
        }
        ...
        // Location
               ...
               Location::create(['title' => 'Bangalore']);
               Location::create(['title' => 'Delhi']);
               Location::create(['title' => 'Kolkata']);
...
//        /* Mailbox protocol */
        ...
        Teams::create(['name' => 'Developer']);
         /* Department */
        Department::create(['name' => 'Support', 'type' => '1']);
        Department::create(['name' => 'Sales', 'type' => '1']);
        Department::create(['name' => 'Operation', 'type' => '1']);
        /* Helptopic */
        help_topic::create(['topic' => 'Support query', 'department' => '1', 'ticket_status' => '1', 'ticket_num_format' => '1', 'status' => '1', 'type' => '1', 'auto_response' => '0']);

        help_topic::create(['topic' => 'Sales query', 'department' => '2', 'ticket_status' => '1', 'ticket_num_format' => '1', 'status' => '0', 'type' => '1', 'auto_response' => '0']);

        help_topic::create(['topic' => 'Operational query', 'department' => '3', 'ticket_status' => '1', 'ticket_num_format' => '1', 'status' => '0', 'type' => '1', 'auto_response' => '0']);
        ...
        Ticket::create(['num_format' => '$$$$-####-####', 'num_sequence' => 'sequence', 'collision_avoid' => '2','help_topic' => '1', 'status' => '1']);
        /* Ticket source */
        $this->call(TicketSourceSeeder::class);
        //  /* Ticket type */
        // Tickettype::create(['name' => 'Default', 'type_desc' => 'Default','status'=>'1','is_default' => '1']);
        // Tickettype::create(['name' => 'Question', 'type_desc' => 'Question','is_default' => '0']);
        ...
        Settings::create(['id' => 'id', 'pagination' => '10','status'=>'1']);
        ...
        CommonSettings::create(['option_name' => 'dummy_data_installation', 'status' => 0]);

        $this->call(RatingSeeder::class);

        Limit_Login::create(['id' => '1']);

        $this->call(JobCondition::class);
        ...
        $this->call(CommonSettingsSeeder::class);
        $this->call(CustomFormSeeder::class);
